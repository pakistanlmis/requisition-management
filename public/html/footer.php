...
<div class="footer">
    <div class="footer-inner" style="width:95%;">
        <p style="float:left; margin-bottom:0px !important;">For any comments and suggestions please write to Support Email</p>
        <p style="float:right; margin-bottom:0px !important;"></p>
    </div>
