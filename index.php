    ...
    <body class="page-header-fixed" style="overflow-x:hidden;">
        ...
        <div class="header-menu"> 
            ...
            <div class="header-inner headerorange">
                <button type="button" class="btn btn-lg btn-primary pull-right btn-head-grey" onclick="window.location.href = ''" > </button>
                        ...
                        <form name="LogIn" id="LogIn" action="application/default/index.php" method="post" onsubmit="return CheckUser()" role="form">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-default btn-form-grey" onclick="javascript: alert('Please contact on Support Email');">Forget Password</button>
        ...
        <div class="footer">
            <div class="footer-inner" style="width:95%;">
                <p style="float:left;">For any comments and suggestions please write to Support Email</p>
