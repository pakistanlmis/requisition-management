...
//echo 'closing:';print_r($closing_bal);
                                    ...
                                    if($province_id==9)echo '  <tr><td align="left" colspan="' . $cols . '" style="background-color:#93d893">' . $prov . ' (Allocations by PPW as on 17 Jan 2019 - Issuance are present in National Section.)</td></tr>';
                                    else echo '  <tr><td align="left" colspan="' . $cols . '" style="background-color:#93d893">' . $prov . '</td></tr>';
                        ...
                        <hr>
                        <h3>Province Wise Summary of Closing Balances of Above Table</h3>
