                                ...
                                foreach ($prov_data as $stk => $prod_data) {
                                    ...
                                    foreach ($prod_data as $prod => $qty) {
                                        ...
                                        foreach ($stk_arr as $k => $stk) {
                                            ...
                                            echo '<td  align="right" >';
                                            if ($stk == 'Issuance') {
                                                echo (!empty($issue_arr[$prov][$stk][$prod]) ? number_format(($issue_arr[$prov][$stk][$prod])) : '0') . '</td>';
                                            } 
                                            elseif ( $stk =='Loans/Relocations') {
                                                ...
                                                {
                                                echo (!empty($issue_arr[$prov][$stk][$prod]) ? number_format(abs($issue_arr[$prov][$stk][$prod])) : '0') . '</td>';
                                        ...
                                        echo '<td align="right" colspan="">' . number_format($cb) . '</td>';
                                        $closing_bal_all[$prov][$prod] = $cb;
                                        echo '</tr>';
                                    }
                                }
                            }
