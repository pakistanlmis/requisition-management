...
if (isset($_REQUEST['id']) && isset($_REQUEST['wh_id'])) {
    ...
    $mainStk = $qryRes['MainStk'];
     $qry = "SELECT
				...
				clr_details.qty_req_dist_lvl1 as approve_qty,
                    ...
                    <div class="col-md-12">
                        <div class="widget" id="printing">
                            ...
                            <div class="widget-body">
                                <form name="frm" id="frm" action="<?php echo APP_URL ?>im/issue_manual_action.php" method="post" onSubmit="return formValidation()">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="col-md-3">
                                                                    ...
                                                                    <td><table  width="100%" class="table-condensed" id="myTable">
                                                                            <tbody>
                                                                                ...
                                                                                if ($status[$proId] == 'Pending' ) {
                                                                                    ...
                                                                                    //query result
                                                                                    //echo $strSql;exit;
                                                                                    $rsSql = mysql_query($strSql) or die("Error: GetAllRunningBatches_in_issue_page");
