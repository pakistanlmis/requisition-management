...
$stockReceive = false;
    ...
    //Get WH Stock By Issue No
      $strSql = "SELECT
        ...
        if(empty($s_count) || $s_count==0)
        {
            $url = 'clr7_view.php?issue_no='.$issue_no.'&search=true';
                                ...
                                <table id="myTable" class="table table-bordered table-condensed  table-vertical-center checkboxs js-table-sortable">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <th> Requisitioned </th>
                                            <th> Dispatched </th>
                                            <th> Received By Consignee <input class="hide dontPrintCls" type="checkbox" id="checkAll" /></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-md-3">
                                                <input type="number" name="received[]" id="<?php echo $i; ?>-received" value="" class="form-control input-sm input-small" />
                                                <input class="hide dontPrintCls" type="checkbox" name="stockid[]" value="<?php echo $row->PkDetailID; ?>" />
                                                <select class="hide trans_types dontPrintCls" name="types[]" id="<?php echo $i; ?>-types" class="form-control input-sm input-small">
                                                    <option selected value="15">Short Received</option>
                                                </select>
                                            </td>
                                            
                                            <td class="center"></td>
                                            <td class="center">
                                                <input style="border:0;background-color: white;" type="text" name="missing[]" id="<?php echo $i; ?>-missing" value="" class="form-control input-sm input-small" readonly="" />
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="" style="text-align: left;">
                                                    <div class="row form-inline">
                                                        <div class="col-md-12 ">
                                                            <div class="control-group">
                                                                <input readonly name="rec_ref" id="rec_ref" type="text" value="<?php echo $issue_no;?>" class="form-control input-sm " />
                                                    ...
                                                    <div class="row form-inline">
                                                        <div class="col-md-12 right">
                                                            <div class="control-group">
                                                                ...
                                                                <input name="rec_date" class="form-control input-sm  right" id="rec_date" value="<?php echo date("d/m/Y"); ?>" type="text" readonly />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                    ...
                                                    <div class="row form-inline">
                                                        <div class="col-md-12">
                                                            <div class="control-group">
                                                                ...
                                                                <textarea maxlength="250" name="remarks" id="remarks" rows="5" cols="60" ></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
