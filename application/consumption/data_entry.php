...
//Checking Do
                if (isset($_REQUEST['Do']) && !empty($_REQUEST['Do'])) {
                    ...
                    // Stakeholder 6 = MSS
                    // Stakeholder 9 = PPHI
                    if ($qryLvl['lvl'] == 4 || $_SESSION['user_stakeholder1'] == 6 || $_SESSION['user_stakeholder1'] == 9 ) {
                        $readonly = '';
                    } else {
                                        ...
                                        if ($isNewRpt == 1) {
                                            ...
                                            <tr>
                                                ...
                                                foreach ($sources as $key => $rowsrc) {
                                                    ...
                                                    <?php } ?>
                                                <td><input class="form-control input-sm text-right" <?= (($src_count > 0) ? 'readonly' : '') ?> autocomplete="off"  type="text" name="FLDRecv<?php echo $itemid[1]; ?>" id="FLDRecv<?php echo $itemid[1]; ?>" size="8" maxlength="10"  value="<?php echo $wh_received; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');" ></td>
                                    ...
                                    if ($key == 130) {
                                        echo $isReadOnly . $style;
                                                    ...
                                                    ?> autocomplete="off"  type="text" name="FLDSrcs<?php echo $itemid[1]; ?>[<?php echo $key; ?>]" id="<?php echo $rowsrc . $itemid[1]; ?>" size="8" maxlength="10"  value="<?php echo $this_value; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');"></td>
                                                           <?php } ?>
                                                <td><input class="form-control input-sm text-right" <?= (($src_count > 0) ? 'readonly' : '') ?> autocomplete="off"  type="text" name="FLDRecv<?php echo $itemid[1]; ?>" id="FLDRecv<?php echo $itemid[1]; ?>" size="8" maxlength="10"  value="<?php echo $rsRow2['wh_received']; ?>" onKeyUp="cal_balance('<?php echo $itemid[1]; ?>');"  ></td>
